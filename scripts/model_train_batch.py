...
from sturgeon_dev.dataclasses import MicroarrayDatasetFromOnlineSimsBatched
...
if __name__ == '__main__':
    ...
    dataset = MicroarrayDatasetFromOnlineSimsBatched(
    ...
    model = Model(
        ...
        device = device,
        adaptive_sampling_correction = False,
        sub_to_fam_dict = None,
        other_class = None,
    )
    ...
    total_steps =  len(dataset.samplers['train'])
